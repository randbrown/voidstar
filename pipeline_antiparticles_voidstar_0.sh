#!/usr/bin/env bash
# pipeline_antiparticles_voidstar_0.sh
#
...
OUTDIR_DEFAULT="~/WinVideos/antiparticles_voidstar_0"
...
PARTICLE_SPARKS_SPEED_DEFAULT=0.25
...
GDRIVE_OUTDIR_DEFAULT="~/GoogleDrive/Music/voidstar/antiparticles"   # e.g. /mnt/c/Users/<you>/Google Drive/My Drive/Videos mapped via symlink
...
main() {
    ...
    if [[ -z "${OUTDIR}" ]]; then
        if [[ -n "$OUTDIR_DEFAULT" ]]; then
            ...
            OUTDIR=$(eval echo "~/WinVideos/antiparticles_voidstar_0")
        fi
    else
