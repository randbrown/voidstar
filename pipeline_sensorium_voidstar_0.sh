#!/usr/bin/env bash
# pipeline_sensorium_voidstar_0.sh
#
...
PIPELINE_LOG_TAG_DEFAULT="sensorium"
...
PARTICLE_SPARKS_FLOOD_EXTRA_SOURCES_DEFAULT=8
...
TITLE_HOOK_TITLE_DEFAULT='// sensorium (hi60t)\n// voidstar'
...
GDRIVE_OUTDIR_DEFAULT="~/GoogleDrive/Music/voidstar/sensorium"   # e.g. /mnt/c/Users/<you>/Google Drive/My Drive/Videos mapped via symlink
...
main() {
    ...
    if [[ -z "${OUTDIR}" ]]; then
        if [[ -n "$OUTDIR_DEFAULT" ]]; then
            ...
            OUTDIR=$(eval echo "/mnt/c/Users/brown/Videos/sensorium_voidstar_0")
        fi
    else
