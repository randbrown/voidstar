#!/usr/bin/env bash
# pipeline_atomism_voidstar_1.sh
#
...
PIPELINE_LOG_TAG_DEFAULT="atomism_1"
...
INPUT_VIDEO_DEFAULT="~/WinVideos/atomism/atomism_voidstar_1.mp4"
...
DIVVY_60S_END_SAMPLE_SECONDS_DEFAULT=16
DIVVY_60S_END_SEGMENTS_DEFAULT=6
DIVVY_180S_END_SAMPLE_SECONDS_DEFAULT=16
DIVVY_180S_END_SEGMENTS_DEFAULT=9
...
BASE_REELS_OVERLAY_PREBUILT_DEFAULT="~/WinVideos/atomism/atomism_voidstar_1_reels_base_overlay.mp4"
...
TITLE_HOOK_TITLE_DEFAULT='// atomism (hi60s_1)\n// voidstar'
