#!/usr/bin/env bash
# pipeline_markov_blankets_voidstar_0.sh
#
...
INPUT_VIDEO_DEFAULT="~/WinVideos/markov_blankets_voidstar_0/markov_blankets_voidstar_0.mp4"
OUTDIR_DEFAULT="~/WinVideos/markov_blankets_voidstar_0"

# Highlight sampling defaults (leave start/full empty for divvy auto defaults).
# Markov blankets: CPM 30, patterns of 7 (14s base unit). Start from 11s onward.
START_SECONDS_DEFAULT="11"
YOUTUBE_FULL_SECONDS_DEFAULT=""
DETECT_AUDIO_START_END_DEFAULT=0

# Timing/style defaults.
CPS_DEFAULT=0.5
GLITCH_SECONDS_DEFAULT=0.4
LOOP_SEAM_SECONDS_DEFAULT=".4"
...
DIVVY_180T_SAMPLE_SECONDS_DEFAULT="28"
DIVVY_180T_N_SEGMENTS_DEFAULT="6"
...
PRE_REELS_GLITCHFIELD_PRESET="custom"   # minimalist | clean | gritty | chaos | custom
PRE_REELS_GLITCHFIELD_SEED=1337
PRE_REELS_GLITCHFIELD_MIN_GATE_PERIOD=6
PRE_REELS_GLITCHFIELD_CUSTOM_ARGS="--effect combo --audio-reactive --beat-threshold 0.57 --beat-prob 1.0 --glitch-hold 10 --combo-glyph-prob 0.72 --combo-stutter-prob 0.35 --combo-alternate-bias 0.62 --color-mode fixed --palette toxic --palette-b sunset --colors 39ff14,7d3cff,b7ff3c,e16bff --palette-mix-speed 0.10 --stutter-slice-prob 0.58 --stutter-slice-shift-max 96 --fx-rgb-split --fx-rgb-shift-max 3 --fx-rgb-prob 0.52 --fx-trail-frames 2 --fx-trail-strength 0.20 --fx-scanline-jitter 0.10 --fx-scanline-step 2 --fx-scanline-shift-max 1 --fx-scanline-brightness 0.96 --fx-vhold-prob 0.03 --fx-vhold-max 4 --beat-flash --beat-flash-strength 0.30 --depth-color 0.22 --motion-color 0.30 --hue-drift 4"
...
GLITCHFIELD_PRESET="custom"      # minimalist | clean | gritty | chaos | custom
GLITCHFIELD_SEED=1337
GLITCHFIELD_MIN_GATE_PERIOD=5
GLITCHFIELD_CUSTOM_ARGS="--effect combo --audio-reactive --beat-threshold 0.54 --beat-prob 1.0 --glitch-hold 14 --combo-glyph-prob 0.42 --combo-stutter-prob 0.62 --combo-alternate-bias 0.48 --color-mode fixed --palette toxic --palette-b sunset --colors 39ff14,7d3cff,c8ff52,f05cff --palette-mix-speed 0.18 --stutter-slice-prob 0.88 --stutter-slice-shift-max 180 --stutter-frame-jitter 3 --stutter-jitter-prob 0.60 --fx-rgb-split --fx-rgb-shift-max 5 --fx-rgb-prob 0.85 --fx-trail-frames 3 --fx-trail-strength 0.34 --fx-scanline-jitter 0.20 --fx-scanline-step 2 --fx-scanline-shift-max 2 --fx-scanline-brightness 0.93 --fx-line-dropout-prob 0.05 --fx-line-dropout-thickness 2 --fx-line-dropout-bright --fx-posterize-levels 5 --fx-vhold-prob 0.08 --fx-vhold-max 8 --beat-flash --beat-flash-strength 0.42 --depth-color 0.35 --motion-color 0.55 --hue-drift 10 --glitch-prob 0.20"      # used when preset=custom
...
PARTICLE_SPARKS_RATE_DEFAULT=0.33
PARTICLE_SPARKS_LIFE_FRAMES_DEFAULT=30
PARTICLE_SPARKS_SPEED_DEFAULT=0.33
PARTICLE_SPARKS_OPACITY_DEFAULT=0.65
PARTICLE_SPARKS_AUDIO_GAIN_DEFAULT=1.55
PARTICLE_SPARKS_COLOR_MODE_DEFAULT="strings"   # white | rgb | random | audio-intensity | antiparticles | strings
...
PARTICLE_SPARKS_FLOOD_SPAWN_MULT_DEFAULT=3.5
...
TITLE_HOOK_TITLE_DEFAULT='// markov_blankets (hi60t)\n// voidstar'
...
TITLE_HOOK_LOGO_MOTION_TRACK_SCALE_DEFAULT=0.85
TITLE_HOOK_LOGO_MOTION_TRACK_RADIUS_DEFAULT=320
...
TITLE_HOOK_LOGO_MOTION_TRACK_LINK_OPACITY_DEFAULT=0.72
TITLE_HOOK_LOGO_MOTION_TRACK_REFRESH_DEFAULT=3
TITLE_HOOK_LOGO_MOTION_TRACK_DECAY_DEFAULT=0.5
TITLE_HOOK_LOGO_OPACITY_DEFAULT=0.2
TITLE_HOOK_LOGO_RGB_SHIFT_OPACITY_DEFAULT=0.06
TITLE_HOOK_LOGO_GLOW_WHITE_DEFAULT=0
TITLE_HOOK_LOGO_GLOW_COLOR_DEFAULT="7CFF41"
TITLE_HOOK_BACKGROUND_DIM_DEFAULT=0.25
TITLE_HOOK_TITLE_LAYER_DIM_DEFAULT=0.0
TITLE_HOOK_TEXT_ALIGN_DEFAULT="left"
TITLE_HOOK_TITLE_JITTER_AUDIO_MULTIPLIER_DEFAULT=0.000004
TITLE_HOOK_SPARKS_DEFAULT=1
TITLE_HOOK_SPARKS_RATE_DEFAULT=1.0
TITLE_HOOK_SPARKS_MOTION_THRESHOLD_DEFAULT=0.5
TITLE_HOOK_SPARKS_OPACITY_DEFAULT=0.65
...
GDRIVE_OUTDIR_DEFAULT="~/GoogleDrive/Music/voidstar/markov_blankets"   # e.g. /mnt/c/Users/<you>/Google Drive/My Drive/Videos mapped via symlink
...
DVDLOGO_START_X_DEFAULT="0.95"
DVDLOGO_START_Y_DEFAULT="0.848"
DVDLOGO_SCALE_DEFAULT="0.33"
DVDLOGO_AUDIO_REACTIVE_SCALE_DEFAULT="0.14"
DVDLOGO_LOCAL_POINT_TRACK_DEFAULT="true"
DVDLOGO_OPACITY_DEFAULT="0.42"
DVDLOGO_BLEND_MODE_DEFAULT="screen"
DVDLOGO_TRAILS_DEFAULT="0.42"
DVDLOGO_AUDIO_REACTIVE_GLOW_DEFAULT="0.85"
...
DVDLOGO_LOCAL_POINT_TRACK_RADIUS_DEFAULT="128"
...
run_optional_title_hook_on_clip() {
    ...
    run_logged python3 "$TITLE_HOOK_SCRIPT" "$input_clip" \
        ...
        $( [[ -n "$TITLE_HOOK_LOGO_GLOW_COLOR" ]] && printf -- '--logo-glow-color %q ' "$TITLE_HOOK_LOGO_GLOW_COLOR" ) \
...
main() {
    ...
    TITLE_HOOK_LOGO_GLOW_COLOR="$TITLE_HOOK_LOGO_GLOW_COLOR_DEFAULT"
    ...
    if [[ -z "${OUTDIR}" ]]; then
        if [[ -n "$OUTDIR_DEFAULT" ]]; then
            ...
            OUTDIR=$(eval echo "~/WinVideos/markov_blankets_voidstar_0")
        fi
    else
