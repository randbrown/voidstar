#!/usr/bin/env bash
# pipeline_quantum_bindings_voidstar_0.sh
#
...
INPUT_VIDEO_DEFAULT="~/WinVideos/quantum_bindings_voidstar_0/quantum_bindings_voidstar_0.mp4"
OUTDIR_DEFAULT="~/WinVideos/quantum_bindings_voidstar_0"
...
TITLE_HOOK_TITLE_DEFAULT='// quantum_bindings (hi60t)\n// voidstar'
...
GDRIVE_OUTDIR_DEFAULT="~/GoogleDrive/Music/voidstar/quantum_bindings"   # e.g. /mnt/c/Users/<you>/Google Drive/My Drive/Videos mapped via symlink
...
main() {
    ...
    if [[ -z "${OUTDIR}" ]]; then
        if [[ -n "$OUTDIR_DEFAULT" ]]; then
            ...
            OUTDIR=$(eval echo "~/WinVideos/quantum_bindings_voidstar_0")
        fi
    else
