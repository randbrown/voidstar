...
INPUT_VIDEO_DEFAULT="/mnt/c/Users/brown/Videos/counterfactural_dimensions_voidstar_0.mp4"
...
GDRIVE_OUTDIR_DEFAULT="/mnt/g/My Drive/Music/voidstar/counterfactural_dimensions_voidstar_0"   # e.g. /mnt/c/Users/<you>/Google Drive/My Drive/Videos
...
main() {
    ...
    if [[ -z "${OUTDIR}" ]]; then
        if [[ -n "$OUTDIR_DEFAULT" ]]; then
            ...
            OUTDIR=$(eval echo "~/WinVideos/counterfactural_dimensions_voidstar_0")
        fi
    else
